...
$strScript = array(
    "user_login.php"=>
      array('warning_sess'=>'ATTENTION : Les sessions ont été désactivées dans votre navigateur. Vous devez les activer ou changer de navigateur',
		...
		'set_pw'=>'Définir le mot de passe',
        'recover'=>'Récupérer',
        ...
        'wrong_mail_app'=>"Une notification a été envoyée sur votre smartphone pour définir un nouveau mot de passe. Appuyez sur la notification et suivez les instructions. Sinon, consultez votre e-mail.",
    ...
    'new_accommodation' => 'Nouveau logement',
		...
		'payment' => 'Paiement',
		'rif_transfer' => 'Les coordonnées bancaires du bénéficiaire seront envoyées par e‑mail après la signature.',
    ...
    'room' => 'Room',
		...
		'notif_confirm_body' => "Merci d'avoir choisi de séjourner dans notre établissement. Vous pouvez facilement accéder à votre réservation, en vérifier le statut et demander des modifications via l'APP Android My Gmonamour ou directement depuis votre compte sur le site web.",
		'notif_call_to_app' => "Vous n'avez pas encore téléchargé l'APP Android My Gmonamour ? Faites-le maintenant https://play.google.com/store/apps/details?id=com.agermani.mygmonamour",
    ...
    'email_add_pass' => "<br>Le compte pour les deux est déjà prêt. Pour l'activer, il suffit de définir un mot de passe:",
    'set_pass' => "👉 Créez le mot de passe et connectez‑vous",
    ...
    '2fa_des' => 'Vous voulez plus de sécurité ? Activez l\'authentification à 2 facteurs : à chaque connexion, vous recevrez un code de vérification par e-mail et/ou sur smartphone',
    'cancel' => 'Annuler',
    'confirm' => 'Confirmer',
    'activate' => 'Activer',
    'deactivate' => 'Désactiver',
    '2faconfirm_des' => 'L\'authentification à 2 facteurs est active. À chaque connexion, vous recevrez un code à saisir après le mot de passe.',
    '2fa_sure_deact' => 'Êtes-vous sûr de vouloir désactiver la 2FA ? Cette action accélère la connexion mais réduit la sécurité de votre compte.',
    '2fa_sure_act' => 'Êtes-vous sûr de vouloir activer la 2FA ? À chaque connexion, vous devrez saisir un code qui vous sera envoyé par e-mail et/ou smartphone.',
    'alert_country' => 'Si vous sélectionnez une commune italienne, le pays doit être IT.',
    'alert_city' => 'Si le pays est IT, vous devez sélectionner une commune valide dans la liste.',
    'alert_country_valid' => 'Pays non valide. Veuillez en sélectionner un dans la liste.',
    'alert_lang' => 'Langue non valide. Vous devez la sélectionner parmi celles disponibles.',
    'invalid_response' => 'Réponse non valide / Session expirée (veuillez vous reconnecter)'
    ),
  ...
  "admin_extra.php" =>
    ...
    'canone2' => ' inclusive of expenses for the consumption of electricity, water and gas. The tenant accepts and undertakes to pay the balance of the lease together with the collection of the keys on the day of arrival or, at his choice, the day before.',
