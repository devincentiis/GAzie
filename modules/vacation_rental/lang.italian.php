...
$strScript = array(
    "user_login.php"=>
      array('warning_sess'=>'ATTENZIONE: Nel tuo browser sono state disabilitate le sessioni. Devi abilitarle oppure cambiare browser',
		...
		'set_pw'=>'Imposta password',
        'recover'=>'Recupera',
        'wrong_mail'=>'Ti è stata mandata una e-mail per impostare una nuova password. Se non la vedi entro pochi minuti controlla nella cartella spam. In alternativa contatta l\'amministratore.',
        'wrong_mail_app'=>"Ti è stata mandata una notifica nel tuo smartphone per impostare una nuova password. Clicca sulla notifica e segui le istruzioni. In alternativa leggi l'e-mail.",
        ...
        '2fa_desc'=>'Scrivi il codice che ti è stato appena inviato via mail/sms/notifica (se non l\'hai ricevuto, controlla nella cartella spam), poi clicca su conferma.',
	...
	"thanks.php" =>
      array('title' => 'Pagina di ringraziamento Vacation rental',
        ...
        'instr_sent' => "<b>Il riepilogo con tutte le informazioni è stato inviato all'indirizzo e-mail fornito</b>.<br>Controlla subito la tua casella di posta<br>",
        'not_received' => "Se non hai ricevuto nulla e dopo aver controllato nella cartella di spam, contatta l'amministratore del sito.",
    ...
    array(array("VPR" => "PREVENTIVO prenotazione", "VOR" => "Prenotazione diretta", "VOW" => "Prenotazione dal Web", "VOG" => "Ordine settimanale del giorno"),
        ...
        'Proprietario',
        'access1' => '<p>Le inviamo, in allegato, una copia della sua prenotazione</p><p>Può accedere alle sue prenotazioni, aggiungere extra, effettuare pagamenti e controllarne lo stato direttamente nel sito dal menu \'Utente\'. ',
    ...
    "admin_house.php" =>
      array('title' => 'Gestione degli alloggi',
        ...
        'accommodation_type_value' => array(3 => 'Appartamento', 4 => 'Casa vacanze', 5=> 'Bed & breakfast', 6=> 'Camera', 7=> 'Locazione turistica'),
        ...
        'tur_tax_value' => array(0 => 'a persona', '1' => 'a persona escluso i minori', '2' => 'a notte e a persona', '3' => 'a notte, a persona, escluso i minori', '4' => 'a soggiorno'),
        'mesg' => array('La ricerca non ha dato risultati!',
            'almeno 1 carattere!',
            'Cambia fornitore'
        )
    ...
    'request_upd_btn'=>'Richiedi modifica o annullamento',
    'booking_req' => 'Richiesta modifica Prenotazione e Contratto di locazione',
    'user' => 'Utente',
    'declaration' => 'Dichiaro che le informazioni sopra riportate sono corrette e che autorizzo la loro elaborazione secondo quanto previsto nel contratto di locazione, da me a suo tempo accettato. La presente vale come firma elettronica ai sensi dell\'art. 1326 c.c. ed è conforme al Regolamento (UE) n. 910/2014 eIDAS  «electronic IDentification, Authentication and trust Services».',
    'body1' => 'Gentile cliente,<br><br>abbiamo ricevuto la sua richiesta di',
    'body2' => 'per la prenotazione ID:',
    'body3' => 'In allegato trova una copia PDF con i dettagli.<br><br>Cordiali saluti,<br>',
    'sent_req' => 'Richiesta inviata correttamente. Una copia ti è stata inviata a',
    'sent_req2' => 'Un amministratore esaminerà la tua richiesta al più presto e riceverai una notifica in merito.',
    'req_title' => 'Richiesta di Modifica o Cancellazione della Prenotazione n. ',
    'action_req' => 'Azione richiesta',
    'deleting' => 'Cancellazione',
    'date_changing' => 'Modifica giorni',
    'changement_acc' => 'Sostituzione alloggio',
    'new_accommodation' => 'Nuovo alloggio',
    'declaration2' => "Dichiaro di essere il titolare della prenotazione e di richiederne irrevocabilmente la <strong> modifica / cancellazione / sostituzione </strong> come sopra indicato. Sono consapevole che tale richiesta è sottoposta ad approvazione del proprietario, avrà valore vincolante ai sensi dell'art. 1326 c.c., modificherà il relativo contratto da me a suo tempo firmato e, se previsto, potrà comportare costi o penali come da clausole contrattuali. Questa è una firma elettronica conforme al Regolamento (UE) n. 910/2014 elDAS.",
		'guest'=>'Ospiti',
		...
		'per_night' => 'a notte',
		'per_person_night' => 'a notte per persona',
		'out_stock' => 'Esaurito per questo periodo',
		'quantity' => 'quantità',
		'per_stay' => 'a soggiorno',
		'per_night_adult' => 'a notte, a persona, escluso i minori',
		...
		'payment' => 'Pagamento',
		'rif_transfer' => 'I riferimenti del conto del beneficiario saranno inviati via e-mail dopo la firma.',
		...
		'expiry' => 'Scadenza',
		'confirm_request' => "Vai avanti",
		'email_confirm_body' => "Salve,<br> Nel ringraziarla per aver scelto di trascorrere una vacanza nella nostra struttura, le inviamo, in allegato, una copia della sua richiesta di prenotazione. ",
		'notif_confirm_body' => "Grazie per aver scelto di soggiornare nella nostra struttura. Potrà facilmente accedere alla prenotazione, controllarne lo stato e chiederne modifiche tramite l'APP Android My Gmonamour oppure direttamente nel suo account del sito web.",
		'notif_call_to_app' => "Non hai ancora scaricato l'APP Android? Fallo adesso https://play.google.com/store/apps/details?id=com.agermani.mygmonamour",
		...
		'email_confirm_add_access_url' => "Potrà facilmente accedere alla prenotazione, controllarne lo stato e chiederne modifiche nel suo account personale tramite l'APP Android My Gmonamour oppure direttamente nel sito web ",
		'email_confirm_add_access_code' => ' e i seguenti codici di accesso: ',
    'email_add_pass' => "<br>L'account per entrambi è già pronto. Per attivarlo, basta impostare una password:",
    'set_pass' => "👉 Crea la password e accedi",
		...
		'FROZEN' => 'CONGELATO (attesa ricezione pagamento, date bloccate)',
		'ISSUE' => 'PROBLEMI da risolvere',
		'CANCELLED' => 'ANNULLATO',
		'changement' => 'Cambiamento stato prenotazione n. ',
		...
		'email_extra_body' =>'<p>Si informa che gli extra richiesti sono stati aggiunti alla prenotazione in oggetto.</p><p>Nella sua pagina utente potrà visionare l\'aggiornamento.  </p>',
		'selfcheck_button' => 'Leggi regole self check-in',
    'self0' => 'Richiedi di effettuare il SELF-checkin',
    'self1' => 'Self check-in In elaborazione',
    'self2' => 'Self check-in Attivato',
    'self3' => 'Self check-in bloccato',
    'self4' => 'Self check-in NON attivabile',
    ...
    'detail_points' => 'Dettaglio punti',
		'2fa_des'=>'Vuoi più sicurezza? Attiva l\'identificazione a 2 fattori: Ad ogni log-in riceverai un codice di verifica via mail e/o su smartphone',
    'cancel' => 'Annulla',
    'confirm' => 'Conferma',
    'activate' => 'Attiva',
    'deactivate' => 'Disattiva',
    '2faconfirm_des' => 'L\'identificazionea 2 fattori è attiva. Ad ogni login riceverai un codice da inserire dopo la password.',
    '2fa_sure_deact' => 'Sei sicuro di voler disattivare la 2FA? Questa azione velocizza il login ma riduce la sicurezza del tuo account.',
    '2fa_sure_act' => 'Sei sicuro di voler attivare la 2FA? Ad ogni login dovrai inserire un codice che ti verrà inviato via mail e/o smartphone.',
    'alert_country' => 'Se selezioni un comune italiano, la nazione deve essere IT.',
    'alert_city' => 'Se la nazione è IT, devi selezionare un comune valido dall\'elenco.',
    'alert_country_valid' => 'Nazione non valida. Selezionane una dall\'elenco.',
    'alert_lang' => 'Lingua non valida. Devi selezionarla fra quelle esistenti.',
    'invalid_response' => 'Risposta non valida / Sessione scaduta (rifare il login)',
    'login' => 'Accedi'
    ),
  ...
  "admin_extra.php" =>
    ...
    array('title' => 'Gestione dei self check-in',
        ...
        'self_ask2' => "Infine, dichiara di essere l'intestatario del contratto di locazione di cui sopra e di essere consapevole che questa richiesta ha valore vincolante ai sensi dell'art. 1326 c.c., solo dopo il corretto invio dei documenti e pagamenti richiesti e previa approvazione del proprietario . <br>La presente manifestazione di volontà è firmata tramite procedura elettronica semplice ai sensi del Regolamento (UE) n. 910/2014 (eIDAS  «electronic IDentification, Authentication and trust Services»). Il firmatario è stato identificato mediante autenticazione con accesso riservato tramite credenziali personali. I dati relativi alla firma (IP, timestamp, identificativo utente, contenuto firmato) sono conservati in modo sicuro per finalità legali e probatorie.</label>",
