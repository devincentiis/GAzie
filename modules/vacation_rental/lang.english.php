...
$strScript = array(
    "user_login.php"=>
      array('warning_sess'=>'ATTENTION: Sessions have been disabled in your browser. You must enable or change browsers',
        ...
        'wrong_mail_app'=>"A notification has been sent to your smartphone to set a new password. Tap the notification and follow the instructions. Alternatively, check your email.",
        ...
        'dashboard' => 'Dashboard',
		'banner_search'=>'Search availability'
      ),
    "browse_document.php" =>
    ...
    array('title' => 'Booking form',
        ...
        'war' => array(
            'ok' => 'ok riempitura array',
            'pay_thanks' => 'Thank you, the payment has been forwarded. It will be confirmed shortly.',
			'extra_thanks' => 'Thank you, the extra has been added successfully.'
		),
		'notifications' => 'Notifications',
    'print'=>'Print',
    'minors' => 'Minors',
	'how_age' => "Age at check-in must be used.",
	'minor_rule' => "Persons under 18 must always be accompanied by an adult. If the accompanying adult is not a parent, they must carry written consent from the persons exercising parental responsibility for the minor. NOTE: Every minor, including newborns, must have their own identity document in any case.",
    'adults' => 'Adults',
    ...
    'new_accommodation' => 'New accommodation',
		...
		'payment' => 'Payment',
		'rif_transfer' => 'The beneficiary account details will be sent by email after signing.',
    ...
    'room' => 'Room',
		...
		'notif_confirm_body' => "Thank you for choosing to stay at our property. You can easily access your booking, check its status and request changes via the My Gmonamour Android APP or directly in your website account.",
		'notif_call_to_app' => "Haven't downloaded the My Gmonamour Android APP yet? Do it now https://play.google.com/store/apps/details?id=com.agermani.mygmonamour",
    ...
    'email_add_pass' => "<br>The account for both is already ready. To activate it, just set a password:",
    'set_pass' => "👉 Create the password and log in",
		'regards' => 'Best regards',
		'download_app' => "Download the Android app to find your ideal holiday home in Grottammare, manage your booking, receive real‑time updates and access all features: <a href=\"https://play.google.com/store/apps/details?id=com.agermani.mygmonamour\" target=\"_blank\">Download from Google Play</a>",
		'of' => 'of',
    ...
    'detail_points' => 'Points details',
    '2fa_des' => 'Want more security? Enable two-factor authentication: at every login you will receive a verification code via email and/or smartphone',
    'cancel' => 'Cancel',
    'confirm' => 'Confirm',
    'activate' => 'Activate',
    'deactivate' => 'Deactivate',
    '2faconfirm_des' => 'Two-factor authentication is active. At every login you will receive a code to enter after your password.',
    '2fa_sure_deact' => 'Are you sure you want to deactivate 2FA? This action speeds up login but reduces your account security.',
    '2fa_sure_act' => 'Are you sure you want to activate 2FA? At every login you will need to enter a code sent to you via email and/or smartphone.',
    'alert_country' => 'If you select an Italian municipality, the country must be IT.',
    'alert_city' => 'If the country is IT, you must select a valid municipality from the list.',
    'alert_country_valid' => 'Invalid country. Please select one from the list.',
    'alert_lang' => 'Invalid language. You must select one of the available options.',
    'invalid_response' => 'Invalid response / Session expired (please log in again)'
    ),
  ...
  "admin_extra.php" =>
    ...
    'accettazione1' => "This contract has been fully read, downloaded and/or printed, approved, and signed online by ticking the relevant boxes: privacy, contract reading, downloading and printing, signature, and acceptance of onerous clauses pursuant to Article 1326 of the Civil Code. Accordingly, it complies with Regulation (EU) No. 910/2014 (eIDAS). The IP address, date, and time of signing are recorded for evidentiary purposes. <br> -This contract shall be binding only upon confirmation by the owner/lessor, and such confirmation is subject to the immediate payment by the tenant of the entire amount requested as a security deposit. This payment constitutes an additional manifestation of the intent to accept.",
	'accettazione2' => 'For any dispute regarding the execution of this contract, the parties agree to and accept the exclusive jurisdiction of the Court of Fermo.',
	'sign-online' => 'Signed electronically',
	'sign-clauses' => 'Pursuant to and for the purposes of Articles 1341 and 1342 of the Italian Civil Code, the lessee declares that they have read and specifically approved online the following clauses: 1,2,3,4,5,6,7.',
	'sign' => 'Signed',
    ),
    "review_viewer.php" =>
