...
$res = gaz_dbi_dyn_query('*', $gTables['clfoco'], "((codice LIKE '$casse%' AND codice > '$mascas') OR (codice LIKE '" . $admin_aziend['masban'] . "%' AND codice > '$masban')) AND status <> 'HIDDEN'", "codice ASC"); //recupero i c/c
