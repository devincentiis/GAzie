    ...
    if (sizeof($paymov->Partners) > 0) {
        ...
        foreach ($paymov->Partners as $p) {
            ...
            if ($ctrl_close_partner == true) {
                echo "<tr>";
                echo "<td class=\"text-right\" colspan='7'> &nbsp;<a title=\"Elimina tutte le partite chiuse di questo fornitore\" class=\"btn btn-xs  btn-elimina\" href=\"delete_schedule.php?partner=" . $p . "\">" . $script_transl['remove'] . $prt['ragso1'] . " " . $prt['ragso2'] . "<i class=\"glyphicon glyphicon-trash\"></i></a></td>";
                echo "</tr>\n";
                echo '<tr><td colspan="7"></td></tr>';
            }
        }
