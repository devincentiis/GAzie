...
$strScript = array("admin_client.php" =>
    array('title' => 'Clienti',
        ...
        'mesg' => array('La ricerca non ha dato risultati!',
            ...
            'Cambia anagrafica'),
        'err' => [
            'ext'=>'Il formato del file non è stato accettato!',
            'fbig'=>'File troppo grande, maggiore di 5MB',
            'samecode'=>'Il codice del cliente &egrave; gi&agrave; esistente, riprova l\'inserimento con quello proposto (aumentato di 1)',
            'ragso1'=>'&Egrave; necessario indicare la Ragione Sociale',
            'indspe'=>'&Egrave; necessario indicare l\'indirizzo',
            'sian'=>'Il codice SIAN &egrave; gi&agrave; esistente, riprova l\'inserimento con quello proposto (aumentato di 1)',
            'email'=>'Indirizzo email formalmente sbagliato',
            'pec_email'=>'Indirizzo PEC formalmente sbagliato',
            'datnas'=>'La data di nascita &egrave; sbagliata',
            'cfpiva'=>'C.F. mancante! In automatico &egrave; stato<br />impostato con lo stesso valore della Partita IVA!',
            'cfpf'=>'E\' una persona fisica, inserire il codice fiscale',
            'samepiva'=>'Esiste una anagrafica con lo stesso Codice Fiscale',
            'samecf'=>'Esiste gi&agrave; un Cliente con lo stesso Codice Fiscale',
            'codfis'=>'Il codice fiscale &egrave; formalmente errato',
            'cfanag'=>'Esiste una anagrafica con lo stesso Codice Fiscale',
            'pianag'=>'Esiste una anagrafica con la stessa partita IVA',
            'clisamepi'=>'Esiste gi&agrave un Cliente con la stessa Partita IVA',
            'codpag'=>'&Egrave; necessario scegliere la modalit&agrave; di pagamento',
            'pariva'=>'La partita IVA &egrave; formalmente errata!',
            'cfpersfis'=>'Codice fiscale sbagliato per una persona fisica',
            'ibanco'=>'L\'IBAN e la nazione sono diversi',
            'iban'=>'L\'IBAN non &egrave; corretto',
            ...
            'intento'=>'La dichiarazione di intento è mancante o scaduta'
            ],
        'link_anagra' => 'Questa partita IVA ha già una anagrafica, clicca per utilizzarla sul piano dei conti come cliente',
        'codice' => "Codice ",
        ...
        'add_id_des_same_company' => 'Aggiungi unità locale',
        'iban' => 'IBAN',
    ...
    array('title' => 'Indirizzi delle destinazioni',
        ...
        'modal_ok_insert' => 'Destinazione verso unità locale inserita con successo clicca sulla X in alto a destra per uscire',
        'status' => 'Visibilit&agrave; alla ricerca',
        'status_value' => array('' => 'Attiva', 'HIDDEN' => 'Disabilitata'),
        'annota' => 'Annotazioni',
    ...
    array('title' => "Lista dei Mandati RID",
        ...
        'code' => "Codice") ,
    "browse_intento.php" =>
    array('title' => "Lista delle dichiarazioni di intento",
        'err' => array('ext'=>'Il formato del file non è stato accettato!',
            'big'=>'Il file è troppo grande!',
            'empty'=>'Il file è vuoto!',
            'sel'=>'Nessun file selezionato',
            'dataintento'=>'La data di registrazione è errata',
            'protocintento'=>'Indicare il protocollo',
            'importointento'=>'Indicare il plafond'),
        'ins_this' => "Inserisci una nuova dichiarazione di intento",
        'upd_this' => "Modifica la dichiarazione di intento ",
        'item' => "Cliente",
        'table_name_ref' => "Tabella di riferimento",
        'dataintento' => "Data di registrazione",
        'protocintento' => "Protocollo ",
        'importointento' => "Importo (plafond)",
        'title' => "Nome originale file",
        'ext' => "Estensione",
        'select' => "Sel.",
        'code' => "Codice"),
