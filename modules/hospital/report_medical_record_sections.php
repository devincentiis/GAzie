...
$rooms_table = "{$gTables['company_data']}";

// campi ammissibili per la ricerca
$search_fields = [
    'id_ref' => "id_ref = %d",
    'descri_data'=> "description LIKE '%%%s%%'",
    'var_data'=> "var LIKE '%%%s%%'",
    'ref_data'=> "ref = 'medical_record_section'"
  ];
...
$ts = new TableSorter(
  ...
  $passo,
  ['id_ref' => 'desc'],
  ['ref_data'=> 'medical_record_section']
);
?>
<script>
$(function() {
  $( "#dialog" ).dialog({
	...
	$('.dialog_delete').click(function() {
		$("p#idcodice").html($(this).attr("id_ref"));
...
<div class="text-center row">
  ...
  <a class="btn btn-default" href="./admin_medical_record_sections.php"> Nuova sezione cartelle cliniche </a>
  </div>
...
// colonna edit
          echo '<td class="text-center"><a class="btn btn-xs btn-edit" href="./admin_room.php?id_ref='.$r['id_ref'].'" title="Modifica nome letto"><i class="glyphicon glyphicon-edit"></i>'.$r['id_ref'].'</a>';
          echo "</td>";
// colonna descrizione
          echo '<td class="text-center">'.$r['description'];
          echo "</td>";
// note
          echo '<td class="text-center">'.$r['var'];
          echo "</td>";
