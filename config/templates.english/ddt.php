...
class DDT extends Template_con_scheda
{
    ...
    function newPage() {
        ...
        $this->Cell(35,6,'Code',1,0,'L',1);
        $this->Cell(82,6,'Description',1,0,'L',1);
        $this->Cell(10,6,'MU',1,0,'L',1);
        //$tipodoc = substr($this->tesdoc["tipdoc"], 0, 1);
        $this->Cell(25,6,'Quantity',1,0,'R',1);
        $this->Cell(25,6,'Price',1,0,'R',1);
        $this->Cell(10,6,'%Dsc',1,1,'R',1,0,1);
    }
    ...
    function pageFooter() {
        ...
        $this->SetFont('helvetica','',9);
        $this->Cell(83, 5,'Sales agent','LTR',0,'C',1);
        ...
        $this->Cell(51,5,'Shipping','LTR',0,'C',1);
		if (!empty($this->docVars->vettor['ragione_sociale'])) {
			$this->Cell(114,5,'Carrier','LTR',0,'C',1);
		} else {
			$this->Cell(57,5,'Packaging type','LTR',0,'C',1);
			$this->Cell(57,5,'Port type','LTR',0,'C',1);
		}
        $this->Cell(22,5,'Transport fee','LTR',1,'C',1);
        ...
        $this->Cell(51,5,'Shipping start','LTR',0,'C',1);
        if (empty($this->docVars->vettor['ragione_sociale'])) {
        ...
        $this->Cell(68,5,'Recipient signature','LTR',1,'C',1);
        if ($this->day > 0) {
           $this->Cell(51,5,'date '.$this->day.'-'.$this->month.'-'.$this->year,'LR',0,'C');
        } else {
           $this->Cell(51,5,'      date','LR',0,'L');
        }
        $this->Cell(68,5,'','R',0);
        $this->Cell(68,5,'','R',1);
        $this->Cell(51,5,'hour '.$this->ora.':'.$this->min,'LRB',0,'C');
        $this->Cell(68,5,'','RB',0);
        $this->Cell(68,5,'','RB',1);
